...
public class ShooterApiQuery {
    ...
    private class SubtitleQueryThread extends Thread {
        ...
        private void parseJson(String str) {
            try {
                ...
                for (int i = 0; i < subTitleArray.length(); i++) {
                    ...
                    LogTool.d(TAG, "subtitleInfo " + i + " :" + subtitleInfo);

                    if (subtitleInfo.getExt() != null)
                        subList.add(subtitleInfo);
                }
            } catch (JSONException e) {
                LogTool.e(TAG, "error on parse Json " + e.toString());
            }
        }
        ...
        public void run() {
            ...
            LogTool.d(TAG, "Shooter url: " + urlstr);
            ...
            try {
                ...
                while ((strline = br.readLine()) != null) {
                    LogTool.d(TAG, strline);
                    builder.append(strline + "/r/n");
                }
                LogTool.i(TAG, "builder.toString():" + builder.toString());
