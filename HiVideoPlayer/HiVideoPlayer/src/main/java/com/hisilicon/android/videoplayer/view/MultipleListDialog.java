...
public class MultipleListDialog extends Dialog {
    ...
    public MultipleListDialog(Activity activity, ArrayList list, boolean isShow, MultipleClickListener multipleClickListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mutiple_list);
        initView();
        initData();
    }
        ...
        mPlayListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if ((listItem != null) && listItem.get(position) != null) {
                    ...
                    multipleClickListener.VideoClick(path);
                }
            }
        });
    }
