...
public class LogTool {
    ...
    private static final String TAG_PREFIX = "[Hisilicon]";
    ...
    public static void v(String tag, String pMsg, Exception e) {
        if (mVFlag) {
            Log.v(tag, getFinalMsg(pMsg), e);
        }
    }
    ...
    public static void d(String tag, String pMsg, Exception e) {
        if (mDFlag) {
            Log.d(tag, getFinalMsg(pMsg), e);
        }
    }
    ...
    public static void i(String tag, String pMsg, Exception e) {
        if (mIFlag) {
            Log.i(tag, getFinalMsg(pMsg), e);
        }
    }
    ...
    public static void w(String tag, String pMsg, Exception e) {
        if (mEFlag) {
            Log.w(tag, getFinalMsg(pMsg), e);
        }
    }
    ...
    public static void e(String tag, String pMsg, Exception e) {
        if (mWFlag) {
            Log.e(tag, getFinalMsg(pMsg), e);
        }
    }
