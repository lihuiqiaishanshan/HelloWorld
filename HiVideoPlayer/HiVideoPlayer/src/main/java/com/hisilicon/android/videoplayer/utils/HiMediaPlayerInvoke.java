...
public class HiMediaPlayerInvoke
{
    ...
    /**
        ...
        <h3>Request:</h3>
            ...
            <tr>
                <td>0</p></td>
                <td>int</p></td>
                <td>Value 1 display all subtile in himediaplayer, value 0 display text in apk and bmp in himediaplayer</p></td>
    ...
    */
    ...
    /**
        ...
        MEDIA_INFO_BUFFER_START means that local buffer starts downloading,if you set ,
        ...
        ,himediaplayer will resume the playback.<br>
    ...
    */
    ...
    public final static int CMD_SET_TRICKPLAY_SPEED = CMD_INVOKE_BASE + 346;

    public final static int CMD_GET_CHANNEL_MODE = CMD_INVOKE_BASE +404;

    public final static int CMD_SET_DTS_DRCMODE = CMD_INVOKE_BASE + 403;

    public final static int CMD_SET_WIN_INPUT_RECT = CMD_INVOKE_BASE + 345;

//    public final static int CMD_GET_DRA_RAW_CHANNEL = CMD_INVOKE_BASE +404;
    /**
     * Vo Window Type
     * */
    public final static int CMD_SET_VOUT_WINDOWS_TYPE = CMD_INVOKE_BASE +405;


    public final static int CMD_GET_DOLBY_AUDIO_FLAG = CMD_INVOKE_BASE + 406;
