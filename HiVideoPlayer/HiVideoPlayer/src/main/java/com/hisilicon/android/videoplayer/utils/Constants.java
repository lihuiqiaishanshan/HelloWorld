...
public class Constants {
    ...
    public final static int SCREEN_ONESIDE_FULL = 2;
    ...
    public static final String KEY_PIP_VIDEO_POS = "hisi_pip_video_pos";
    public static final String KEY_PIP_VIDEO_TAG = "hisi_pip_video_tag";
    ...
    public static final int ONECYCLE = 1;

    public static final int ALLCYCLE = 2;
    ...
    public static final int USBUNINSTALL = 1001;

    public static final int UPDATEDRAINFO = 1002;


    public static final int POWER_OFF = 1003;

    public static final int GET_DOLBY_INFO = 1004;
}
