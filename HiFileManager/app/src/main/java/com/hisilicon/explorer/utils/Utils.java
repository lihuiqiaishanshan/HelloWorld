...
public class Utils {
    ...
    private static final String DEBUG_TAG = "FileManagerDebug";
    ...
    public static boolean isDemoEnable() {
        String demoEnable = SystemProperties.get("ro.product.target", "aosp");

        if ("demo".equals(demoEnable))
            return true;
        else
            return false;
    }
