package com.hisilicon.explorer.db;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String SAMBA_TABLE_NAME = "samba";
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql = "create table samba (_id integer primary key autoincrement,"
                + "server_ip varchar(100),nick_name varchar(100),server_name varchar(100), work_path varchar(300),"
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        String sql = "drop table if exists samba";
        db.execSQL(sql);
        onCreate(db);
    }
}
