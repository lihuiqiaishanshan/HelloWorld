...
public class SubtitleSelectorView extends RelativeLayout implements
                                    View.OnKeyListener, View.OnFocusChangeListener, OnTouchListener
{
    private static final String TAG = "SubtitleSelectorView";
    ...
    private SubtitleSelectorDialog mDialog;

    public SubtitleSelectorView(SubtitleSelectorDialog dialog, Context context, String title)
    {
        super(context);
        mContext = context;
        mTitle = title;
    ...
    private void initView()
    {
        ...
        menuBtn.setText(mDialog.getCurrentSubtitle());
                ...
                if (event.getAction() == KeyEvent.ACTION_DOWN)
                {
                    switch (keyCode)
                    {
                        case KeyEvent.KEYCODE_DPAD_LEFT:
                            mDialog.setPreSubtitle();
                            ChangeSrsState();
                            return true;

                        case KeyEvent.KEYCODE_DPAD_RIGHT:
                            mDialog.setNextSubtitle();
                            ChangeSrsState();
                            return true;
