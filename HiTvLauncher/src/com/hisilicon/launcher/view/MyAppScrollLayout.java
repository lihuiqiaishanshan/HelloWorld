...
public class MyAppScrollLayout extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        LogHelper.d(TAG, "childCount=" + childCount);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        LogHelper.d(TAG, "moving to screen " + mCurScreen);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                LogHelper.d(TAG, "MotionEvent Action down!");
            ...
            case MotionEvent.ACTION_UP:
                LogHelper.d(TAG, "MotionEvent Action up!");
                ...
                if (velocityX > SNAP_VELOCITY && mCurScreen > 0
                    ...
                    LogHelper.d(TAG, "mCurScreen=" + (mCurScreen - 1));
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        LogHelper.d(TAG, "onInterceptTouchEvent-slop:" + mTouchSlop);
