...
public class Constants {
    ...
    /* Sort by time */
    public final static int SORT_TIME = 3;
    ///* the name of database */
    //public static String MARK_DB_NAME = "hisi_media.db"; //for fority
    ...
    public static final String CONTENT_URI = "content://com.android.mysetting/item";
    /* Resume broken play */
    public static final int CONTINUE_PLAYER_FLAG = 1;
