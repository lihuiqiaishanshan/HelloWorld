...
public class TouchInterceptor extends ListView {
    ...
    private static final String TAG = "HiMusic_Interceptor";
        ...
        for (int i = 0;; i++) {
            ...
            if (v == null) {
                ...
                try {
                    ...
                    Log.e(TAG,"TouchInterceptor-getChildAt",ex);
    ...
    private void doExpansion() {
        ...
        for (int i = 0;; i++) {
            ...
            if (mDragPos < numheaders && i == numheaders) {
                ...
                // instead
                if (vv.getId() == first.getId()) {
                    visibility = View.INVISIBLE;
                } else {
                    height = mItemHeightExpanded;
                }
            } else if (vv.getId() == first.getId()) {
        ...
        if ((mDragListener != null || mDropListener != null)
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_CANCEL:
                    ...
                    if (mRemoveMode == SLIDE && ev.getX() > r.right * 3 / 4.0) {
