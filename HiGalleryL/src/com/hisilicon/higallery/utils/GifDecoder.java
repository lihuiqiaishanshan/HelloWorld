package com.hisilicon.higallery.util;
...
public class GifDecoder {
    ...
    public static final int MAX_STR_LEN = 10240;
    ...
    protected static int MaxShowGifSize = 0;
    protected static final int MaxHeapSize = 128*1024*1024;
    ...
    public Bitmap getFrame(int n) {
        Bitmap im = null;
        if ((n >= 0) && (n < frameCount) && frames != null && frames.size() > 0) {
    ...
    protected void decodeImageData() {
        ...
        for (i = 0; i < npix;) {
            if (err()) {
                Log.d(TAG, "input stream occured an error");
                return;
            }
            if (top == 0) {
                if (bits < code_size) {
    ...
    protected void readImage() {
        ...
        try {
            ...
            Log.e(TAG,"in run OutOfMemoryError");
        }
    }
    ...
    /**
     * recycle GifFrame and recycle bitmaps in GifFrame
     */
